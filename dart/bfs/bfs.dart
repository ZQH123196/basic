...
main(List<String> args) {
    ...
    Map<String, String> related = bfs(start, grid);
    
    showPathByRelated(grid, related, start.toString(), end.toString());

}

Map bfs(List start, List<String> grid) {
    // [row, col]
    var direction = [
                    [-1, -1], [-1, 0], [-1, 1],
                    [0, -1], [0, 1],
...
void showPathByRelated(List<String> grid, Map<String, String> related, String start, String end) {

    String nowPoint = end.toString();
    for (var str in grid) {
